      ...
      <div className="mx-auto max-w-6xl grid md:grid-cols-2 gap-16 items-center">
        ...
        <div>
          ...
          <div className="mt-10 grid grid-cols-3 gap-6 border-t border-zinc-200 pt-8">
            <div>
              <p className="text-3xl font-bold font-serif text-zinc-900">
                {dict.stat1Value}
              </p>
              <p className="text-sm text-zinc-500 mt-1">{dict.stat1Label}</p>
            </div>
            <div>
              <p className="text-3xl font-bold font-serif text-zinc-900">
                {dict.stat2Value}
              </p>
              <p className="text-sm text-zinc-500 mt-1">{dict.stat2Label}</p>
            </div>
            <div>
              <p className="text-3xl font-bold font-serif text-zinc-900">
                {dict.stat3Value}
              </p>
              <p className="text-sm text-zinc-500 mt-1">{dict.stat3Label}</p>
            </div>
          </div>
        </div>
      </div>
